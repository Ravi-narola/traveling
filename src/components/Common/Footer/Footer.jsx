      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2">Ahmedabad, Gujarat, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:ravinarola3334@gmail.com" className="d-block" >ravinarola3334@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:7698040513" className="d-block" >7698040513</a>
          </div>
        ...
        <p className="text-light">   @ 2024. ravinarola All rights reserved </p> 
        </Col>
        </Row>
